...
def test_find_dups():
    ...
    assert test_answer == dup_windows, "The correct test array is [[[3, 2], [4, 3], " \
                                       "[5, 4], [6, 5]]]."
...
def test_find_dups_empty():
    ...
    assert test_answer == dup_windows, "There should be no table provided in this " \
                                       "test."
